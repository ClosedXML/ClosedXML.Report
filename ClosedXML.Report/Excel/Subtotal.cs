...
namespace ClosedXML.Report.Excel
{
    public class Subtotal : IDisposable
    {
        ...
        public void AddHeaders(int column)
        {
            ...
            _groups
                ...
                .ForEach(g =>
                {
                    ...
                    g.HeaderRow.Clear(XLClearOptions.Contents); // ClosedXML issue 844
        ...
        private SubtotalGroup CreateGroup(IXLRange groupRng, int groupClmn, int level, string title, SummaryFuncTag[] summaries, bool pageBreaks,bool isGrandTotal=false)
        {
            ...
            summRow.Clear(XLClearOptions.Contents); //TODO Check if the issue persists (ClosedXML issue 844)
