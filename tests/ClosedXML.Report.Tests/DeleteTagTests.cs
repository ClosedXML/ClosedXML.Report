...
namespace ClosedXML.Report.Tests
{
    public class DeleteTagTests: TagTests
    {
        ...
        private IEnumerable<object> GenerateItems()
        {
            ...
            {
                new {FirstName = "Alice", LastName = "Liddell", Country = "Wonderland", Address = "Westminster, London, England", BirthDay = DateTime.Parse("1852-05-04").ToShortDateString()},
                new {FirstName = "Lewis", LastName = "Carroll", Country = "UK", Address = "Daresbury, Cheshire, England", BirthDay = DateTime.Parse("1832-01-27").ToShortDateString()},
                new {FirstName = "Charles", LastName = "Dodgson", Country = "UK", Address = "Daresbury, Cheshire, England", BirthDay = DateTime.Parse("1832-01-27").ToShortDateString()},
            };
        }
    }
}
