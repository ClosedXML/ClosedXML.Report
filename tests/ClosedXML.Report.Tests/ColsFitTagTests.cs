...
namespace ClosedXML.Report.Tests
{
    public class ColsFitTagTests: TagTests
    {
        ...
        private IEnumerable<object> GenerateItems()
        {
            ...
            {
                new {FirstName = "Alice", LastName = "Liddell", Country = "Wonderland", Address = "Westminster, London, England", BirthDay = "1852-05-04"},
                new {FirstName = "Lewis", LastName = "Carroll", Country = "UK", Address = "Daresbury, Cheshire, England", BirthDay = "1832-01-27"},
                new {FirstName = "Charles", LastName = "Dodgson", Country = "UK", Address = "Daresbury, Cheshire, England", BirthDay = "1832-01-27"},
            };
        }
    }
}
